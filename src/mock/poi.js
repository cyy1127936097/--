...
export const routeList = [
  {
    ...
    pois: [1, 4, 5, 3, 2, 6],
    days: [
      { day: 1, title: '第一天', items: ['鼓浪屿', '中山路步行街', '八市海鲜市场'] },
      { day: 2, title: '第二天', items: ['厦门大学', '南普陀寺', '沙坡尾'] },
      { day: 3, title: '第三天', items: ['曾厝垵', '环岛路骑行', '黄厝沙滩'] }
    ]
  },
  {
    id: 2,
    ...
    pois: [1, 4, 6, 2],
    days: [
      { day: 1, title: '第一天', items: ['鼓浪屿', '中山路步行街'] },
      { day: 2, title: '第二天', items: ['厦门大学', '环岛路骑行'] },
      { day: 3, title: '第三天', items: ['曾厝垵', '黄厝沙滩'] }
    ]
  }
]
...
export function getHotPoiList(limit = 10) {
